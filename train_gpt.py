...
class Hyperparameters:
    ...
    val_batch_size = int(os.environ.get("VAL_BATCH_SIZE", 8_388_608))  # 8M tokens = 1024 seqs/GPU × 8 GPUs
...
def eval_val(
    ...
    H = args.model_dim
    model.eval()
    # Unwrap DDP to access model internals for streaming eval
...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x: Tensor, attn_mode: str = "causal") -> Tensor:
        ...
        if attn_mode == "xsa_bidir":
            y = _xsa_bidir_attention(q, k, v, self.scale, gqa)
